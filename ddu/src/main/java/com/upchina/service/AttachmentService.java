...
import com.upchina.model.Attachment;
...
public class AttachmentService  extends BaseService<Attachment, Integer>{
    ...
    public void insertAttachmentList(List<Attachment> list,Integer targetId)
    {
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(Attachment.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<Attachment> list=selectByExample(exp);
