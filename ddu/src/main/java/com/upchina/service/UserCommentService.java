...
public class UserCommentService  extends BaseService<UserComment, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(UserComment.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<UserComment> list=selectByExample(exp);
