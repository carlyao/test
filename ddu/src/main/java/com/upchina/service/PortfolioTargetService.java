...
public class PortfolioTargetService  extends BaseService<PortfolioTarget, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(PortfolioTarget.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<PortfolioTarget> list=selectByExample(exp);
