...
@Service("userDirectQuestionService")
public class UserDirectQuestionService  extends BaseService<UserDirectQuestion, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(UserDirectQuestion.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<UserDirectQuestion> list=selectByExample(exp);
