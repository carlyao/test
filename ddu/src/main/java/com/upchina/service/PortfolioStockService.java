...
import com.upchina.model.PortfolioStock;
...
@Service("portfolioStockService")
public class PortfolioStockService  extends BaseService<PortfolioStock, Integer>{
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(PortfolioStock.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<PortfolioStock> list=selectByExample(exp);
