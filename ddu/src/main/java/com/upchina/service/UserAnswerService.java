...
import com.upchina.model.UserAnswer;
...
public class UserAnswerService  extends BaseService<UserAnswer, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(UserAnswer.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<UserAnswer> list=selectByExample(exp);
