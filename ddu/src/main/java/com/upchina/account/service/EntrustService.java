...
import com.upchina.account.model.Entrust;
...
public class EntrustService  extends BaseService<Entrust, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(Entrust.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<Entrust> list=selectByExample(exp);
