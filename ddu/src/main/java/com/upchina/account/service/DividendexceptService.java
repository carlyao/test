...
import com.upchina.account.model.Dividendexcept;
import com.upchina.service.BaseService;
/**
 * Created by codesmith on 2015
 */

@Service("dividendexceptService")
public class DividendexceptService  extends BaseService<Dividendexcept, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(Dividendexcept.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<Dividendexcept> list=selectByExample(exp);
