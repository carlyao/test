...
import com.upchina.account.model.DividendexceptHis;
import com.upchina.service.BaseService;
/**
 * Created by codesmith on 2015
 */

@Service("dividendexceptHisService")
public class DividendexceptHisService  extends BaseService<DividendexceptHis, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(DividendexceptHis.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<DividendexceptHis> list=selectByExample(exp);
