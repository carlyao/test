...
import com.upchina.account.model.EntrustHis;
import com.upchina.service.BaseService;
/**
 * Created by codesmith on 2015
 */

@Service("entrustHisService")
public class EntrustHisService  extends BaseService<EntrustHis, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(EntrustHis.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<EntrustHis> list=selectByExample(exp);
