...
import com.upchina.account.model.DividendtaxHis;
import com.upchina.service.BaseService;
/**
 * Created by codesmith on 2015
 */

@Service("dividendtaxHisService")
public class DividendtaxHisService  extends BaseService<DividendtaxHis, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(DividendtaxHis.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<DividendtaxHis> list=selectByExample(exp);
