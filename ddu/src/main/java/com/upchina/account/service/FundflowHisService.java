...
import com.upchina.account.model.FundflowHis;
import com.upchina.service.BaseService;
/**
 * Created by codesmith on 2015
 */

@Service("fundflowHisService")
public class FundflowHisService  extends BaseService<FundflowHis, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(FundflowHis.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<FundflowHis> list=selectByExample(exp);
