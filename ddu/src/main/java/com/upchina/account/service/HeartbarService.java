...
import com.upchina.account.model.Heartbar;
import com.upchina.service.BaseService;
/**
 * Created by codesmith on 2015
 */

@Service("heartbarService")
public class HeartbarService  extends BaseService<Heartbar, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(Heartbar.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<Heartbar> list=selectByExample(exp);
