...
import com.upchina.account.model.Fundflow;
...
public class FundflowService  extends BaseService<Fundflow, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(Fundflow.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<Fundflow> list=selectByExample(exp);
