...
import com.upchina.account.model.Dividendtax;
import com.upchina.service.BaseService;
/**
 * Created by codesmith on 2015
 */

@Service("dividendtaxService")
public class DividendtaxService  extends BaseService<Dividendtax, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(Dividendtax.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<Dividendtax> list=selectByExample(exp);
