...
import com.upchina.account.model.Actionrule;
import com.upchina.service.BaseService;
/**
 * Created by codesmith on 2015
 */

@Service("actionruleService")
public class ActionruleService  extends BaseService<Actionrule, Integer>{
     /**
    ...
    public boolean isExist(String inputName,String value,int id) {
        Example exp = new Example(Actionrule.class);
        Example.Criteria criteria = exp.createCriteria();
        criteria.andEqualTo(inputName, value);
        List<Actionrule> list=selectByExample(exp);
